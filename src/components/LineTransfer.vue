                ...
                <div class="search_wapper">
                    <div class="search_area">
                        <div class="row" v-on:click="Toggle('from')">
                            <span class="dot"><img src="../assets/line/arrow.png" alt="">
                        ...
                        <div class="row" style="border-bottom: none" v-on:click="Toggle('to')">
                            <span class="dot"><img src="../assets/line/round_gray.png" alt="" >
...
export default {
  ...
  mounted: function () {
    console.log(this.fullname.substr(this.fullname.indexOf("省")+1,this.fullname.indexOf("市")-3));
    this.autocomplete = new AMap.Autocomplete({
      city: this.fullname.substr(this.fullname.indexOf("省")+1,this.fullname.indexOf("市")-3)
    })
  },
  methods: {
      ...
      this.autocomplete.search(this.keywords, function (status, result) {
        if (status === 'complete' && result.info === 'OK') {
          ...
          for (let i = 0; i < tips.length; i++) {
            ...
            if (tips[i].location !== '' && undefined !== tips[i].location && tips[i].district.substr(0, 6) === this.fullname) {
              this.hisTips.push({
